...
echo  "$($PSQL "SELECT DISTINCT name FROM teams FULL JOIN games AS a ON a.winner_id = teams.team_id FULL JOIN games AS b ON b.opponent_id = teams.team_id WHERE a.year = 2014 OR b.year = 2014 ORDER BY name")"
